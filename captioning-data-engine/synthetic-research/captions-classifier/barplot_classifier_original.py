...
# Load the JSON file
with open('./synthetic-research/captions-classifier/classification_results_original.json') as f:
    data = json.load(f)
...
g.savefig("./synthetic-research/captions-classifier/probability_thresholds_original.png")